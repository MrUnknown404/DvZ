...
public class ModItems {
	...
	//-//Monster Items
	public static final Item SPAWNAS_ZOMBIE = new ItemSpawnAsMob("spawnaszombie", ModCreativeTabs.DVZITEMS, "ÅòcSpawn as a Zombie", EnumMonsterType.zombie);
	public static final Item SPAWNAS_CREEPER = new ItemSpawnAsMob("spawnascreeper", ModCreativeTabs.DVZITEMS, "ÅòcSpawn as a Creeper", EnumMonsterType.creeper);
	public static final Item SPAWNAS_SKELETON = new ItemSpawnAsMob("spawnasskeleton", ModCreativeTabs.DVZITEMS, "ÅòcSpawn as a Skeleton", EnumMonsterType.skeleton);

...
public class ModItems {
	...
	public static final Item DEBUG_MANA = new ItemDebugMana("debugmana", null, "ÅòaDebug item! Åò8(ÅòbGives 250 manaÅò8)");
	...
	public static final Item DWARVEN_LONGBOW = new ItemDwarvenLongBow("dwarvenlongbow", ModCreativeTabs.DVZITEMS, "ÅòaLeft click to create arrows Åò8Åòl(WIP)");
	public static final Item CRAFTER_BOW = new ItemCrafterBow("crafterbow", ModCreativeTabs.DVZITEMS, "ÅòaLeft click to create arrows Åò8Åòl(WIP)");

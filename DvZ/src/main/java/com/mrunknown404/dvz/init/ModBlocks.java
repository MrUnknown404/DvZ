...
public class ModBlocks {
	...
	public static final Block CRACKEDDWARVENSTONE = new BlockBase("crackeddwarvenstone", Material.ROCK, SoundType.STONE, ModCreativeTabs.DVZBLOCKS, "", 1.5f, 100.0f, "pickaxe", 1);

...
public class ModBlocks {
	...
	public static final Block HARDDWARVENSTONE = new BlockBase("harddwarvenstone", Material.ROCK, SoundType.STONE, ModCreativeTabs.DVZBLOCKS, "", 23.5f, 100.0f, "pickaxe", 2);
	public static final Block CRACKEDHARDDWARVENSTONE = new BlockBase("crackedharddwarvenstone", Material.ROCK, SoundType.STONE, ModCreativeTabs.DVZBLOCKS, "", 3.0f, 100.0f, "pickaxe", 2);
	public static final Block DWARVENSTONE = new BlockBase("dwarvenstone", Material.ROCK, SoundType.STONE, ModCreativeTabs.DVZBLOCKS, "", 2.5f, 100.0f, "pickaxe", 2);
	public static final Block CRACKEDDWARVENSTONE = new BlockBase("crackeddwarvenstone", Material.ROCK, SoundType.STONE, ModCreativeTabs.DVZBLOCKS, "", 2.0f, 100.0f, "pickaxe", 1);

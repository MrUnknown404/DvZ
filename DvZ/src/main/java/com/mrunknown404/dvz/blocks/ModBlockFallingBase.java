...
public class ModBlockFallingBase extends BlockFalling implements IHasModel {
	...
	public ModBlockFallingBase(String name, Material material, SoundType soundType, CreativeTabs tab, float hardness, float resistance, String toolType, int harvestLevel) {
		super(material);
